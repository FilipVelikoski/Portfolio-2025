...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        memoji:
          "inset 1px 4px 6px rgba(0,0,0,.4), inset 0px -2px 16px -3px rgba(0,0,0,.2)",
      ...
      background: {
        circle:
          "linear-gradient(120deg, hsla(0, 0%, 100%, 0.5), hsla(0, 0%, 100%, 0.1))",
      },
      animation: {
        eclipse: "eclipse 3s linear infinite",
        marquee: "marquee 8s linear infinite",
        "god-rays":
          "god-rays var(--duration) cubic-bezier(0.15, 0, 0.85, 1) infinite alternate",
      },
      keyframes: {
        eclipse: {
          "0%": {
